...
class ExerciseStatusAdapter(val items:ArrayList<ExerciseModel>):RecyclerView.Adapter<ExerciseStatusAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when{
            model.getIsSelected()->{
                holder.tvItem.background= ContextCompat.getDrawable(holder.itemView.context,R.drawable.item_circular_thin)
            ...
            model.getIsCompleted()->{
                ...
                holder.tvItem.background= ContextCompat.getDrawable(holder.itemView.context,R.drawable.item_circ_grey_bg)
                holder.tvItem.setTextColor(Color.parseColor("#212121"))
